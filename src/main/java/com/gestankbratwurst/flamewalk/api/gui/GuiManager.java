package com.gestankbratwurst.flamewalk.api.gui;

import com.gestankbratwurst.flamewalk.api.gui.abstraction.AutoUpdated;
import com.gestankbratwurst.flamewalk.api.gui.abstraction.InventoryHandler;
import com.gestankbratwurst.flamewalk.api.gui.baseimpl.AbstractGuiHandler;
...
public class GuiManager {
  ...
  public void initializeAndRegister(AbstractGuiHandler abstractGuiHandler) {
    Inventory inventory = abstractGuiHandler.initializeInventory();
    abstractGuiHandler.decorate();
    this.registerHandledInventory(inventory, abstractGuiHandler);
  }
